...
import { COLORS, getLetterGrade } from "../Colors.tsx";
import StarIcon from "@mui/icons-material/Star";
import { local } from "./GetGEData.tsx";
...
const calculateAverageGPA = (gradeDistribution) => {
  let totalGPA = 0;
  let totalStudents = 0;
...
const fetchGradeDistribution = async (code) => {
  try {
...
const useInstructor = (code, instructor) => {
  return useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        const matchedInstructor = instructors.find((fullName) => {
